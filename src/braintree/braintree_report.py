...
def process_search_results(search_results,braintree_connection):
    ...
    for transaction in search_results.items:
        ...
        try:
            ...
            if (transaction.vault_customer is not None):
                t['transaction_customer_id'] =  transaction.vault_customer.id
                t['transaction_customer_company'] = transaction.vault_customer.company
